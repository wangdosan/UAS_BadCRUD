...
class Login_Username_Password_Salah(unittest.TestCase):
    ...
    def test_1_login_page(self):           
        ...
        self.browser.find_element(By.ID, "inputUsername").send_keys("tes")
        self.browser.find_element(By.ID, "inputPassword").send_keys("tes")
